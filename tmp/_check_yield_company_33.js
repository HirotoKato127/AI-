...
// pages/yield/yield.js?v=20260219_33
...
function renderCompanyMsTable() {
  ...
  MS_DEPARTMENTS.forEach((dept, index) => {
    ...
    const distributeButton = hasMsPeriod ? `<div class="ms-distribute-wrap"><button type="button" class="ms-distribute-btn" data-ms-distribute data-scope="company" data-dept="${dept.key}" data-metric="${metricKey}">\u65E5\u5272\u308A\u914D\u5206</button></div>` : "";
...
function renderPersonalMsTable(deptKey) {
  ...
  members.forEach((member, index) => {
    ...
    const distributeButton = hasMsPeriod ? `<div class="ms-distribute-wrap"><button type="button" class="ms-distribute-btn" data-ms-distribute data-scope="personalMs" data-dept="${deptKey}" data-member="${memberId}" data-metric="${currentMetricKey}">\u65E5\u5272\u308A\u914D\u5206</button></div>` : "";
    const metricRowspan = hasMsPeriod ? 3 : 1;
    const metricCell = `
...
// pages/yield-company/yield-company.js
