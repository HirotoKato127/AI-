...
const routes = {
  ...
  candidates: () => import("../pages/candidates/candidates.js?v=20260168"),
  "ad-performance": () => import("../pages/ad-performance/ad-performance.js?v=20260134"),
  teleapo: () => import("../pages/teleapo/teleapo.js?v=20260144"),
...
const pageCSS = {
  ...
  teleapo: "pages/teleapo/teleapo.css?v=20260135",
