...
const routes = {
  ...
  candidates: () => import("../pages/candidates/candidates.js?v=20260322_63"),
  "ad-performance": () => import("../pages/ad-performance/ad-performance.js?v=20260322_12"),
  teleapo: () => import("../pages/teleapo/teleapo.js?v=20260322_14"),
  referral: () => import("../pages/referral/referral.js?v=20260322_54"),
